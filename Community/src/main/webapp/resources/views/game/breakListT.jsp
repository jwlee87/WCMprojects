...
// 	console.log(nowTime);
	...
	$(".stats").on("click", function(){
		var win = window.open("../break/yList", "게임통계", 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width='+w+',height='+h);
