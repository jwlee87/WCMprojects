...
$(document).ready(function(){
	...
	var html = "";
	var t_head = "<tr><th>NO</th><th>일시</th><th>유저번호</th><th>닉네임</th><th>코드</th><th>코인</th><th>전 코인</th><th>후 코인</th><th>메모</th></tr>";
	...
	function makeHTML(json){
		...
		for(var i=0; i < json.length; i++){
			...
			var coin = json[i]._COIN;
			var bCoin = json[i]._BCOIN;
			var aCoin = json[i]._ACOIN;
			...
			html += "<tr style='border: 1px solid #ccc;'>"
				 ...
				 +"<td>"+nickName+"</td>"
				 +"<td>"+pCode+"</td>"
				 +"<td>"+numberWithCommas(coin)+"</td>"
				 +"<td>"+numberWithCommas(bCoin)+"</td>"
				 +"<td>"+numberWithCommas(aCoin)+"</td>"
				 +"<td>"+memo+"</td>"
				 +"</tr>";
		}
